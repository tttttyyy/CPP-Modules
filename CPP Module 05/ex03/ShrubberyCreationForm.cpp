...
ShrubberyCreationForm::ShrubberyCreationForm() : AForm("SCB", 145, 137), m_target("noTarget")
{}

ShrubberyCreationForm::ShrubberyCreationForm(std::string target) : AForm("SCB", 145, 137), m_target(target)
{}

ShrubberyCreationForm::ShrubberyCreationForm(const ShrubberyCreationForm & toCopy) : m_target(toCopy.m_target) {}
